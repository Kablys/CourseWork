...
\section{Klasterizavimas}
	...
	\subsection{Centroidais paremta klasterizacija}
		\subsubsection{K-vidurkių}
			...
			\ltang{K-vidurkių}{K-means} \cite{macqueen1967some} padalinjimo metodas yra vienas pirmujų ir dažniausiai naudojamų klasterizavimo metodų. \\
			...
			\begin{itemize}
				...
				%\item Tampa per lėtas su dideliais duomeų kiekiais
			...
			\subsubsubsection{K-means modifikacijos}
			% Iliustracija
